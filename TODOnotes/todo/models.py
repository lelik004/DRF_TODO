...
class Project (models.Model):
    ...
    group_of_users = models.ManyToManyField(CustomUser, unique=False,  verbose_name='Пользователи проекта')
...
class ToDo (models.Model):
    ...
    #     Project, unique=False, on_delete=models.CASCADE, verbose_name='Название проекта задачи'
    # )
    project = models.ManyToManyField(
        Project, verbose_name='Название проекта задачи'
    )
